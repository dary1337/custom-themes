...
const ru_changelog = [
    //
    'Добавлен поддержка @import',
    'Добавлена поддержка обновления тем в фоновом режиме',
];

const en_changelog = [
    //
    'Added @import support',
    'Added support for updating themes in the background',
];
    ...
    ru: {
        ...
        settings: [
            ...
            },
            {
                ...
                description: `Происходит раз в день`,
                default: true,
            },
        ],
        loader: {
